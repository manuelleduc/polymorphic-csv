...
public class CsvParsingTest {
  ...
  public void bashTest3() {
    try {
      ...
      _builder_2.newLine();
      _builder_2.append("echo $[$(wc -l < /home/yannick/Bureau/dossier_test/Copy_Sans_nom_1.csv)-1]");
      _builder_2.newLine();
      _builder_2.append("head -1 /home/yannick/Bureau/dossier_test/Copy_Sans_nom_1.csv | sed \'s/[^,]//g\' | wc -c");
      _builder_2.newLine();
      Pair<String, String> _mappedTo = Pair.<String, String>of(_builder_1.toString(), _builder_2.toString());
      this._polymorphicCsvCompilationTestHelper.assertFileCompilesTo(_builder, Collections.<String, CharSequence>unmodifiableMap(CollectionLiterals.<String, CharSequence>newHashMap(_mappedTo)));
    } catch (Throwable _e) {
  ...
  public void pythonTest() {
    try {
      ...
      _builder_2.newLine();
      _builder_2.append("with open(\"/udd/ynamour/Desktop/dossier_test/test_copy.csv\", \"w\", encoding=\"utf-8\") as read_file:");
      _builder_2.newLine();
      _builder_2.append("    ");
      _builder_2.append("read_W = csv.writer(read_file)");
      _builder_2.newLine();
      _builder_2.append("    ");
      _builder_2.append("with open(\"/udd/ynamour/Desktop/dossier_test/Sans_nom_1.csv\", \"r\", encoding=\"utf-8\") as write_file:");
      _builder_2.newLine();
      _builder_2.append("        ");
  ...
  public void loadModel() {
    try {
      ...
      _builder_20.newLine();
      _builder_20.append("with open(\"/tmp/test.csv\", \"r\", encoding=\"\") as CSV_file:");
      _builder_20.newLine();
      _builder_20.append("\t");
      ...
      _builder_20.newLine();
      _builder_20.append("with open(\"/tmp/test2.csv\", \"w\", encoding=\"\") as read_file:");
      _builder_20.newLine();
      _builder_20.append("    ");
      _builder_20.append("read_W = csv.writer(read_file)");
      _builder_20.newLine();
      _builder_20.append("    ");
      _builder_20.append("with open(\"/tmp/test.csv\", \"r\", encoding=\"\") as write_file:");
      _builder_20.newLine();
      _builder_20.append("        ");
  ...
  public void loadModelPython() {
    try {
      ...
      _builder_8.newLine();
      _builder_8.append("with open(\"/tmp/test.csv\", \"r\", encoding=\"\") as CSV_file:");
      _builder_8.newLine();
      _builder_8.append("\t");
