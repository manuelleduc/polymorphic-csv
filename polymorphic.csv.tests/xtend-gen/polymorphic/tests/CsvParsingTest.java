...
public class CsvParsingTest {
  ...
  public void bashTest_old() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("for D in ./data/mpackage/*/\t\t# for each folder in directory");
      _builder_1.newLine();
      _builder_1.append("do");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("output=\"result\"");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("target=$D$output\"_mpackage_\"${D:14:-1}\t\t\t# results\' file\t\t");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("\t");
      ...
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("./src-gen/mpackage/bash/a.b.java.C.sh $D >> $target");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("echo \"\" >> $target");
      _builder_1.newLine();
  ...
  public void RTest() {
    try {
      ...
      _builder_2.newLine();
      _builder_2.append("write.csv( /home/yannick/Bureau/dossier_test/Sans_nom_1.csv, paste(root,\"/home/yannick/Bureau/dossier_test/Copy_Sans_nom_1.csv\",sep=\"\"), quote=FALSE, row.names=FALSE )");
      _builder_2.newLine();
      Pair<String, String> _mappedTo = Pair.<String, String>of(_builder_1.toString(), _builder_2.toString());
      this._polymorphicCsvCompilationTestHelper.assertFileCompilesTo(_builder, Collections.<String, CharSequence>unmodifiableMap(CollectionLiterals.<String, CharSequence>newHashMap(_mappedTo)));
    } catch (Throwable _e) {
