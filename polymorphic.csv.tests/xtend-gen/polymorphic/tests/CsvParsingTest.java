...
public class CsvParsingTest {
  ...
  public void loadModel() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("for a_e in csv.reader(open(\'/tmp/test.csv\', \'rt\', encoding=\'\')):");
      _builder_1.newLine();
      _builder_1.append("  ");
      ...
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("File 11 : /myProject/./src-gen/uuu/run.sh");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("rm -r ./logs");
      _builder_1.newLine();
  ...
  public void loadModelPython() {
    try {
      ...
      _builder_1.append("import csv");
      _builder_1.newLine();
      _builder_1.append("print(sum(1 for row in csv.reader(open(\'/tmp/test.csv\', \'rt\', encoding=\'\'))))");
      _builder_1.newLine();
      _builder_1.append("print(sum(1 for row in csv.reader(open(\'/tmp/test2.csv\', \'rt\', encoding=\'\'))))");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("File 5 : /myProject/./src-gen/foo/run.sh");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("rm -r ./logs");
      _builder_1.newLine();
