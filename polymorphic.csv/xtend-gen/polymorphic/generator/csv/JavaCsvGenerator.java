...
public class JavaCsvGenerator implements ICsvGenerator {
  ...
  public void generate(final Model content, final Language language, final IFileSystemAccess2 fsa) {
    ...
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("public void clear() {");
    _builder_5.newLine();
    _builder_5.append("\t\t");
    _builder_5.append("_map.clear();");
    _builder_5.newLine();
    _builder_5.append("\t\t");
    _builder_5.append("_cols = 0;");
    _builder_5.newLine();
    _builder_5.append("\t\t");
    _builder_5.append("_rows = 0;");
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("}");
    _builder_5.newLine();
    ...
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("public int rows() {");
    _builder_5.newLine();
    _builder_5.append("\t\t");
    _builder_5.append("return _rows;");
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("}");
    _builder_5.newLine();
    ...
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("public int cols() {");
    _builder_5.newLine();
    _builder_5.append("\t\t");
    _builder_5.append("return _cols;");
    _builder_5.newLine();
    _builder_5.append("\t");
    _builder_5.append("}");
    _builder_5.newLine();
