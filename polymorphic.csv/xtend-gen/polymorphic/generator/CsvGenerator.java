...
public class CsvGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder_7.newLine();
    _builder_7.newLine();
    _builder_7.append("for D in ./data/");
    ...
    _builder_7.newLine();
    _builder_7.append("\t");
    _builder_7.append("output=\"result\"");
    _builder_7.newLine();
    _builder_7.append("\t");
    _builder_7.append("target=$D$output\"_");
    String _name_10 = content.getName();
    _builder_7.append(_name_10, "\t");
    _builder_7.append("_\"${D:14:6}\t\t\t# results\' file\t\t");
    _builder_7.newLineIfNotEmpty();
    _builder_7.newLine();
    _builder_7.append("\t");
