...
public class CsvGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder_10.append("../exec_main.sh");
    StringConcatenation _builder_11 = new StringConcatenation();
    _builder_11.append("#!/bin/bash");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("# main exec.sh");
    _builder_11.newLine();
    _builder_11.append("# syntax : bash exec_main.sh");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("echo \"--------------------\"");
    _builder_11.newLine();
    _builder_11.append("echo \"### EXEC_MAIN.SH ###\"");
    _builder_11.newLine();
    _builder_11.append("echo \"--------------------\"");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("# for each .pcsv present");
    _builder_11.newLine();
    _builder_11.append("for file in *.pcsv");
    _builder_11.newLine();
    ...
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("# remove .pcsv to the file == name of the current .pcsv");
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("name=${file:0:-5}");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("echo \"####### Launch of $name #######\"");
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("echo \"\"");
    _builder_11.newLine();
    ...
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("# launch local exec.sh as main");
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("./src-gen/$name/exec.sh main");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("echo \"####### End of $name #######\"");
    _builder_11.newLine();
    _builder_11.append("    ");
    _builder_11.append("echo \"--------------------\"");
    _builder_11.newLine();
    ...
    _builder_11.append("echo \"\"");
    _builder_11.newLine();
    _builder_11.append("echo \"### END OF EXEC_MAIN.SH ###\"");
    _builder_11.newLine();
    _builder_11.append("echo \"--------------------\"");
    _builder_11.newLine();
    ...
    _builder_12.append("/exec.sh");
    StringConcatenation _builder_13 = new StringConcatenation();
    _builder_13.append("#!/bin/bash");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("# local exec.sh ");
    String _name_10 = content.getName();
    _builder_13.append(_name_10);
    _builder_13.newLineIfNotEmpty();
    _builder_13.append("# syntax : bash exec.sh");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("# path of \"code_X\" for main call / local call");
    _builder_13.newLine();
    _builder_13.append("# path1 = where are data of the .pcsv");
    _builder_13.newLine();
    _builder_13.append("if [ \"$1\" = \"main\" ] ; then path1=\"./data/");
    String _name_11 = content.getName();
    _builder_13.append(_name_11);
    _builder_13.append("/\" ; else path1=\"../../data/");
    String _name_12 = content.getName();
    _builder_13.append(_name_12);
    _builder_13.append("/\" ; fi");
    _builder_13.newLineIfNotEmpty();
    _builder_13.newLine();
    _builder_13.append("# for each data folder in directory_pcsv");
    _builder_13.newLine();
    _builder_13.append("for Data_folder_csv in $path1*/");
    _builder_13.newLine();
    _builder_13.append("do");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# data\'s name for main call / local call = code\'s name + data\'s name");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if [ \"$1\" = \"main\" ] ; then dataName=${Data_folder_csv:7:-1} ; else dataName=${Data_folder_csv:11:-1} ; fi");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# remove \"/\" for naming");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("dataName2=${dataName/\"/\"/_}");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# only data\'s name");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("dataName=$( echo $dataName | cut -f2 -d/ )");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# path and name of the results\' file\t");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("target=$Data_folder_csv\"result_\"$dataName2");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# creation of the results file as target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("printf \"////////////////////////////// \" > $target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("date >> $target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("uname -a >> $target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("echo \"\" >> $target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("echo \"## ");
    String _name_13 = content.getName();
    _builder_13.append(_name_13, "\t");
    _builder_13.append(" ## $dataName\" >> $target");
    _builder_13.newLineIfNotEmpty();
    _builder_13.append("\t");
    _builder_13.append("echo \"\" >> $target");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("echo \"########## $dataName\"");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# path for main call / path for local call");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# path2 = where are the generated files for the selected languages");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if [ \"$1\" = \"main\" ] ; then path2=\"./src-gen/");
    String _name_14 = content.getName();
    _builder_13.append(_name_14, "\t");
    _builder_13.append("\" ; else path2=\"./\" ; fi");
    _builder_13.newLineIfNotEmpty();
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# for each mentioned language");
    _builder_13.newLine();
    {
      EList<Language> _languages_2 = content.getLanguages();
      for(final Language l_2 : _languages_2) {
        _builder_13.append("\t");
        _builder_13.append("echo \"# START ");
        ...
        _builder_13.append(" #\" >> $target");
        _builder_13.newLineIfNotEmpty();
        _builder_13.append("\t");
        _builder_13.append("echo \"\" >> $target");
        _builder_13.newLine();
        _builder_13.append("\t");
        _builder_13.append("# command line\'s syntax by language");
        _builder_13.newLine();
        _builder_13.append("\t");
        ...
        if (_name_17 != null) {
          switch (_name_17) {
            case "java":
              ...
              String _plus = ("mvn compile exec:java -Dexec.mainClass=\"myjava\" -Dexec.args=\"${Data_folder_csv}\" -f \"${path2}/" + _name_18);
            ...
            case "commons":
              ...
              String _plus_3 = ("mvn compile exec:java -Dexec.mainClass=\"mycommons\" -Dexec.args=\"${Data_folder_csv}\" -f \"${path2}/" + _name_19);
        ...
        _builder_13.append(_switchResult, "\t");
        _builder_13.newLineIfNotEmpty();
        _builder_13.append("\t");
        _builder_13.append("echo \"\" >> $target");
        _builder_13.newLine();
        _builder_13.append("\t");
        _builder_13.append("echo \"# END ");
    ...
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("# START PARSING results to fill GRID.txt");
    _builder_13.newLine();
    _builder_13.append("# for each data folder in directory_pcsv");
    _builder_13.newLine();
    _builder_13.append("for Data_folder_csv in $path1*/");
    ...
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("awk -v path=$path1 \'");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("BEGIN { }");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("{");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# name of the .pcsv");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if ($0 ~ \"^## \") { code_name = $2 }");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# name of the data");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if ($0 ~ \"^## \") { data_name = $4 }");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# languages generated");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if ($0 ~ \"^# START \") { languages[n++] = $3 ; target_result = NR+2 }");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# results collect");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if (NR == target_result) { results[m++] = $1 }");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("}");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("END {");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("# header already present");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("if ( system(\"test -s \" path \"GRID.txt\") ) {");
    _builder_13.newLine();
    _builder_13.append("\t\t");
    _builder_13.append("l1 = sprintf(\"%-20s\",code_name)");
    _builder_13.newLine();
    _builder_13.append("\t\t");
    _builder_13.append("i = 0");
    _builder_13.newLine();
    _builder_13.append("\t\t");
    ...
    _builder_13.newLine();
    _builder_13.append("\t\t");
    _builder_13.append("for(c=0;c<var;c++) {printf \"|\"} ; print \"\"");
    _builder_13.newLine();
    _builder_13.append("\t\t");
    _builder_13.append("print l1");
    _builder_13.newLine();
    _builder_13.append("\t\t");
    _builder_13.append("for(c=0;c<var;c++) {printf \"|\"} ; print \"\"");
    _builder_13.newLine();
    ...
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("l2 = sprintf(\"%-20s\",data_name)");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("i = 0");
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("while ( results[i] ) { l2 = l2 sprintf(\"|%-10s\",results[i] ); i++ }");
    _builder_13.newLine();
    _builder_13.append("\t");
    ...
    _builder_13.newLine();
    _builder_13.append("\t");
    _builder_13.append("\' $Data_folder_csv\"result_\"* >> $path1\"GRID.txt\"");
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("done");
    _builder_13.newLine();
    ...
    _builder_13.newLine();
    _builder_13.newLine();
    _builder_13.append("# START PARSING GRID.txt to fill GRID.html");
    _builder_13.newLine();
    _builder_13.append("awk -v path=$path1 \'");
    _builder_13.newLine();
    _builder_13.append("BEGIN {");
    _builder_13.newLine();
    _builder_13.append("print \"<!DOCTYPE html>\"");
    _builder_13.newLine();
    _builder_13.append("print \"<html>\"");
    _builder_13.newLine();
    _builder_13.append("print \"<head>\"");
    _builder_13.newLine();
    _builder_13.append("print \"<title>GRID.html</title>\"");
    _builder_13.newLine();
    _builder_13.append("print \"<meta charset=\"utf-8\" />\"");
    _builder_13.newLine();
    _builder_13.append("print \"</head>\"");
    _builder_13.newLine();
