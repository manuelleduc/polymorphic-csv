...
public class CsvGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("# for each data folder in directory_pcsv -- PARSING --");
    _builder_11.newLine();
    _builder_11.append("for Data_folder_csv in $path1*/");
    _builder_11.newLine();
    _builder_11.append("do");
    ...
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("awk -v path=$path1 \'");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("BEGIN { }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("{");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("if ($0 ~ \"^## \") { code_name = $2 }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("if ($0 ~ \"^## \") { data_name = $4 }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("if ($0 ~ \"^# START \") { languages[n++] = $3 ; target_result = NR+2 }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("if (NR == target_result) { results[m++] = $1 }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("}");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("END {");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("if ( system(\"test -s \" path \"GRID.txt\") ) {");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("l1 = sprintf(\"%-20s\",code_name)");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("i = 0");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("while ( languages[i] ) { l1 = l1 sprintf(\"|%-10s\",languages[i]); i++ }");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("var = 20+(11*i)");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("for(c=0;c<var;c++) {printf \"|\"} ; print \"\"");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("print l1");
    _builder_11.newLine();
    _builder_11.append("\t\t");
    _builder_11.append("for(c=0;c<var;c++) {printf \"|\"} ; print \"\"");
    _builder_11.newLine();
    ...
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("l2 = sprintf(\"%-20s\",data_name)");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("i = 0");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("while ( results[i] ) { l2 = l2 sprintf(\"|%-10s\",results[i] ); i++ }");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("print l2");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("} # END END");
    _builder_11.newLine();
    _builder_11.append("\t");
    _builder_11.append("\' $Data_folder_csv\"result_\"* >> $path1\"GRID.txt\"");
    _builder_11.newLine();
    _builder_11.newLine();
    _builder_11.append("done");
    _builder_11.newLine();
    _builder_11.append("# END -- PARSING --");
    _builder_11.newLine();
