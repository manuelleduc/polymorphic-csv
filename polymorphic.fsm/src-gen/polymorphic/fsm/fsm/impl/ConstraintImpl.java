 ...
 * </p>
 * <ul>
 *   <li>{@link polymorphic.fsm.fsm.impl.ConstraintImpl#getName <em>Name</em>}</li>
 *   <li>{@link polymorphic.fsm.fsm.impl.ConstraintImpl#isTrue <em>True</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.CONSTRAINT__NAME, oldName, name));
  }
  ...
  public void setTrue(boolean newTrue)
  {
    ...
    true_ = newTrue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.CONSTRAINT__TRUE, oldTrue, true_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FsmPackage.CONSTRAINT__NAME:
        return getName();
      case FsmPackage.CONSTRAINT__TRUE:
        return isTrue();
    }
